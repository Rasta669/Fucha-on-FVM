task("create-nft1", "mints fuchanft of breed fuchaSimba").addParam("contract", "The FuchaNft address").addParam("toaccount", "The account to mint to")
    ...
    .setAction(async (taskArgs) => {
        ...
        const transaction = await fucha.createNft(1, { value: fee.toString() })
        ...
        const uri_tx = await fucha.setTokenUri(Id, tokenUris[1])
        await uri_tx.wait()
